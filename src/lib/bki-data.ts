export const BKI_COSTS: Record<string, { name: string, unit: 'm2' | 'm3', pricePerUnit: number }> = {
    ...
    "334": { name: "Außentüren und -fenster", unit: "m2", pricePerUnit: 518 }, // Schätzwert als Fallback
    "340": { name: "Innenwände", unit: "m2", pricePerUnit: 250 },
    "344": { name: "Innentüren und -fenster", unit: "m2", pricePerUnit: 250 }, // Schätzwert als Fallback
