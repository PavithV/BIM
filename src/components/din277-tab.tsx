...
export function Din277Tab({ result }: Din277TabProps) {
  if (!result) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        <LayoutGrid className="w-12 h-12 text-muted-foreground/50 mb-4" />
        <h3 className="font-semibold text-lg">DIN 277 Flächenauswertung</h3>
        <p className="text-muted-foreground text-sm mt-1">
          Starten Sie die Modellprüfung, um die DIN 277 Auswertung hier anzuzeigen.
        </p>
      </div>
    );
  }
  ...
  if (result.spaces.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        ...
        <h3 className="font-semibold text-lg">Keine Raumdaten gefunden</h3>
        <p className="text-muted-foreground text-sm mt-1 max-w-md">
          Das IFC-Modell enthält keine <code className="text-xs bg-muted px-1 rounded">IfcSpace</code> Entitäten.
          Für eine DIN 277 Auswertung müssen Räume im Modell definiert sein.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-medium">Flächenübersicht nach DIN 277</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-lg border p-3">
              ...
              <p className="text-xs text-muted-foreground">Bruttogrundfläche</p>
            </div>
            <div className="rounded-lg border p-3">
              ...
              <p className="text-xs text-muted-foreground">Nettoraumfläche</p>
            </div>
            <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-3">
              ...
              <p className="text-xs text-muted-foreground">Nutzungsfläche</p>
            </div>
            <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-3">
              ...
              <p className="text-xs text-muted-foreground">Verkehrsfläche</p>
            </div>
            <div className="rounded-lg border border-purple-200 bg-purple-50/50 p-3 col-span-2">
              ...
              <p className="text-xs text-muted-foreground">Technikfläche</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-medium">
            Raumdetails ({spaces.length} Räume)
          </CardTitle>
        </CardHeader>
                  ...
                  <TableCell className="font-medium">
                    <div>
                      <span className="block truncate max-w-[180px]">
                        {space.name || space.longName || `Raum #${space.expressID}`}
                      </span>
